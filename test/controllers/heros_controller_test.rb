...
class HerosControllerTest < ActionController::TestCase
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post :create, hero: { faction: "Dire", hasguide: @hero.hasguide, melrange: "Melee", name: "Sohil", oftype: "Agility" }
    end
  ...
  test "should update hero" do
    patch :update, id: @hero, hero: { faction: "Radiant", hasguide: @hero.hasguide, melrange: "Range", name: "Sohil", oftype: "Strength" }
    assert_redirected_to hero_path(assigns(:hero))
  end
